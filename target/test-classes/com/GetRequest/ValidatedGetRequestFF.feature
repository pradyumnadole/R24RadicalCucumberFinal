Feature: Validate Get RequestNew
...
Scenario: 4.Validate Title of book is and author
    #Given hit the URI111
    Given Title of book is "Speaking JavaScript"
    Then validate author is "Axel Rauschmayer"